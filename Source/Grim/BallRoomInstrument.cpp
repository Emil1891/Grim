...
void ABallRoomInstrument::InteractSuccessful()
{
	...
	ActiveAudioPlayer->Play(GetPlayTime()); 
...
float ABallRoomInstrument::GetPlayTime() const
{
	return FMath::Fmod(GetWorld()->GetTimeSeconds(), 15.f); 
}
